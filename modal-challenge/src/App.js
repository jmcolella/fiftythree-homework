  ...
  render() {
    return (
      <div className="App">
        ...
        <button
          onClick={
            () => this.handleClickButton( "In 1516, the Reinheitsgebot (German Beer Purity Law) was put in to effect. This law brought organization to brewing, only allowing malt, hops and water to be included in beer. Yeast, which at the time was not discovered, would later be added to the law." )
          }
        >
          German Beer Law
        </button>
